...
public class HibernateConfiguration {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/debt_app_db");
        dataSource.setUsername("postgres");
        dataSource.setPassword("RadikDev.6899");
        return dataSource;
    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.B31.Muxammadamin.entity"); // Replace with your package
